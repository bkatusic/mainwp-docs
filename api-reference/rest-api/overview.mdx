...
description: >-
  MainWP REST API v2 overview, authentication setup, and endpoint categories for
  sites, clients, tags, updates, costs, users, settings, monitoring, API keys,
  posts, pages, and batch operations.
---
