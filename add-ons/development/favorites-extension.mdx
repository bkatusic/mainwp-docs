...
description: "The MainWP Favorites Extension lets you store frequently used plugins and themes for quick installation and organize them into groups. Favorites are stored locally on your MainWP Dashboard and do not use the WordPress.org Favorites API, so your privacy is maintained."
addonType: "extension"
---
...
<div id="addon-data" style={{ display:"none" }} data-title="Favorites" data-purchase-url="https://mainwp.com/extension/favorites/" data-pricing-tier="pro" data-bundle="MainWP Pro" data-addon-type="extension" data-version="5.2" data-developer="MainWP" data-changelog-url="https://mainwp.com/changelog/mainwp-favorites-extension/" data-owned-by="Jestart LLC" data-privacy-url="https://mainwp.com/mainwp-plugin-privacy-policy/" />
...
<video className="w-full rounded-xl" autoPlay loop muted playsInline src="/images/add-ons/favorites-add-new.mp4" />
