...
Go to the **MainWP > Add-ons > Code Snippets > Execute Snippet** page![MainWP Code Snippets > Snippet Options](/images/add-ons/code-snippets-options.jpg)
</Step>
