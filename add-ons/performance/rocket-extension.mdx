...
MainWP Rocket Extension allows you to Clear quickly or Preload cache on your child sites. On the **MainWP > Add-ons > Rocket** page, under the **WP Rocket** tab, you will find **Clear Cache**, **Preload Cache,** and **Purge OPCache** buttons. ![Screenshot of WP Rocket tab showing Clear Cache, Preload Cache, and Purge OPCache buttons](/images/add-ons/wp-rocket-cache-buttons.jpg)
