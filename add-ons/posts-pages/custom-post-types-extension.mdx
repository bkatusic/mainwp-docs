...
<Warning>
**Editor Support** - The extension adds WordPress admin metaboxes on the MainWP Dashboard site for custom post type publishing. Child sites need the matching custom post type registered; they do not need Classic Editor for the extension import action.
</Warning>
