...
<Step title="You will be sent to the Classic Editor Add New screen">
</Step>
...
<Step title="Go to the desired custom post type list on your MainWP Dashboard site">
</Step>
<Step title="Locate the post and click Edit to open it in Classic Editor">
</Step>
