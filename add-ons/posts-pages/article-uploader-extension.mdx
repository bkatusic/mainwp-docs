...
<Step title="Go to the MainWP > Add-ons > Article Uploader > Upload Articles page">
Go to the **MainWP > Add-ons > Article Uploader > Upload Articles** page ![Upload Articles page with file selection interface](/images/add-ons/article-uploader-upload-page.png)
</Step>
...
<Step title="Go to the MainWP > Add-ons > Article Uploader > Import Articles page">
Go to the **MainWP > Add-ons > Article Uploader > Import Articles** page ![Import Articles page with file selection interface](/images/add-ons/1a30343780ea.png)
</Step>
