...
- This flow uses MainWP Bridge (`bridge.mainwp.com`) for secure authentication. See the [MainWP Bridge Privacy Policy](https://mainwp.com/mainwp-bridge-privacy-policy).
