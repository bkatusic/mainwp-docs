...
<AccordionGroup>
  <Accordion title="Email Customization" icon="book-open" defaultOpen>
    <CardGroup cols={3}>
      ...
      <Card title="Custom Email Template" icon="settings" href="/add-ons/agency/how-to-modify-the-pro-reports-email-template">
...
- [Create a custom Pro Reports email template](/add-ons/agency/how-to-modify-the-pro-reports-email-template) - Copy and customize a built-in email template
