...
The [MainWP Child Reports plugin](https://wordpress.org/plugins/mainwp-child-reports/) records changes on your child sites and communicates them to the Pro Reports Extension. Built on the [Stream Plugin](https://wordpress.org/plugins/stream/), it currently requires PHP 5.6 or higher.
