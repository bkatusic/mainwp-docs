...
description: "MainWP removed White Label options that hide plugin and update areas on child sites to comply with WordPress.org plugin rules. You can still apply similar behavior manually with custom code on child sites."
---
