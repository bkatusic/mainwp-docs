...
Cost Tracker Assistant adds convenience features to the core Cost Tracker feature: automated notifications for expiring subscriptions and streamlined cost entry when uploading plugins or themes.
