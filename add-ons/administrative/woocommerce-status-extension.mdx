...
On the **MainWP > Add-ons > MainWP WooCommerce Status Extension** page, you can see all your child sites with the WooCommerce plugin installed. Here you can see for each child site:
