...
On the **MainWP > Add-ons > Monitoring > WooCommerce Status** page, you can see all your child sites with the WooCommerce plugin installed and active. Here you can see for each child site:
