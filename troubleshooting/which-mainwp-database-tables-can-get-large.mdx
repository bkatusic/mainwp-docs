...
There is no built-in MainWP Child UI setting for this retention value. You can apply the filter directly on the child site, or deploy it centrally from MainWP Dashboard with the [Code Snippets](/add-ons/development/code-snippets-extension) add-on at **MainWP > Add-ons > Code Snippets > Execute Snippet**.
