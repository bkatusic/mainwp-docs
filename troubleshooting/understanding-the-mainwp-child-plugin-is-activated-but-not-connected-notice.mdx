...
Enter the child site URL, administrator username, and the authentication method required by MainWP Child settings: administrator password, Unique Security ID, or both.
</Step>
