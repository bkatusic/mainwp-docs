...
If an extension shows an available update but won't install, reset the extension activation and license connection before retrying the update:
...
Activate the license for the extension again.
</Step>
