...
<Tabs>
  ...
  <Tab title="Claude Code">
    ...
    Claude Code can alternatively install the server as a plugin, together with an agent skill and `/mainwp:*` workflow commands. See [Claude Code Plugin](/mcp-server/claude-code-plugin).
  </Tab>
