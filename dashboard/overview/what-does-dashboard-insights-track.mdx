...
description: >-
  Dashboard Insights tracks activity events from your MainWP Dashboard and child
  sites through shared Network Activity logs. This reference lists all tracked
  events.
---

Dashboard Insights provides analytics data about your MainWP Dashboard and child site usage. This page lists all events that Insights tracks from the shared Network Activity logs dataset.
