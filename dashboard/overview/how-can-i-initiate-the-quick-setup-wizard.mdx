...
description: Access the MainWP Quick Setup Wizard from MainWP Settings > Tools to rerun initial setup steps.
---
...
<Steps>
<Step title="Open MainWP Settings">
Click the profile image in the top-right corner, then select **MainWP Settings**.
</Step>
<Step title="Open Tools">
Click **Tools** in the Settings submenu.
</Step>
