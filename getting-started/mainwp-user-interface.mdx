...
<video className="w-full rounded-xl" autoPlay loop muted playsInline src="/ui-reorder-widgets.mp4" />

### Resize Widgets

Grab the lower-right corner of any widget and drag to adjust its size.

<video className="w-full rounded-xl" autoPlay loop muted playsInline src="/resize-widgets.mp4" />

### Save or Load Layouts

Use **Layout** in the header to save your current widget arrangement or load a previously saved layout.

<video className="w-full rounded-xl" autoPlay loop muted playsInline src="/save-load-layouts.mp4" />

### Enable or Disable Widgets

Open **Page Settings**, check or uncheck widgets in the list, and click **Save Settings**.

<video className="w-full rounded-xl" autoPlay loop muted playsInline src="/enable-disable-widgets.mp4" />

## Widgets

### Update Overview

![Update Overview widget showing WordPress, plugin, theme, and translation updates](/updates-overview-widget.png)
...
![Connection Status widget displaying site sync information](/connection-status-widget.png)
...
### Network Activity (Sites Changes)

![Sites Changes widget showing recent activity log](/network-activity-site-changes.png)
...
![Recent Posts widget with post management actions](/recent-posts-widget.png)
...
![Site Hardening widget showing security issues overview](/site-hardening.png)
...
![Plugins widget displaying installed plugins list](/plugins-widget.png)
...
![Themes widget displaying installed themes list](/themes-widget.png)
...
![MainWP Dashboard main navigation sidebar](/navigation.png)
...
| API Access (REST API) | API key and application password management |
| Settings | Dashboard configuration |
| Info | System, cron, logs, event monitor, and privacy pages |

### Header Elements

![MainWP Dashboard header with sync, add new, and user menu options](/header-elements.png)

| Element | Function |
|---------|----------|
| Sync | Synchronize all connected sites (or the current site context) |
...
| Theme Switcher | Toggle light/dark mode or open the theme selector |
| User Menu | Access MainWP Settings, MainWP Tools, System Info, Privacy Policy, Get Help, WP Admin, community, account, and logout |
...
![DataTables interface showing sortable columns and pagination](/tables.png)

### Actions Menu

![Actions menu in table row](/actions-menu.png)

The actions menu appears in the far right column of most MainWP tables.

### Sorting Options

![Table column header with sorting arrows](/sorting-options.png)
...
<video className="w-full rounded-xl" autoPlay loop muted playsInline src="/columns-order.mp4" />

### Bulk Actions

![Bulk actions dropdown menu above table](/bulk-actions.png)
...
![Table filter options in top-right corner](/table-filter.png)

Use the filters in the top-right to narrow down table data.

### Pagination

![Table pagination controls](/pagination.png)
...
![Manage Plugins & Themes table features](/manage-themes-manage-plugins-feature.png)
...
![Select Sites metabox with site selection checkboxes](/select-sites.png)
...
![Sidebar accordion with collapsible sections](/sidebar-actions.png)
...
![Custom Event Monitor log interface](/custom-event-monitor.png)
