...
The Quick Setup Wizard launches after installing MainWP Dashboard. It walks you through initial configuration for the best experience. Skip it by clicking **Skip the Setup Wizard** and return later from **MainWP > Settings > MainWP Tools**.
...
1. Verify MainWP Child is activated on the site you want to connect
...
5. Click **Connect Site and Proceed**
6. Repeat for additional sites as needed
...
<Note>
- Restart the wizard anytime from **MainWP > Settings > MainWP Tools**
- Use **Continue Without Adding Sites** or **Continue Without Creating Clients** if you are unsure about any options
...
- **Add-ons requiring plugins:** Install the plugin and synchronize default settings automatically
- **Standalone add-ons:** Synchronize add-on default settings only
