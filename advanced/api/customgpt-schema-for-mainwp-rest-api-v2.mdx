...
**NOTE:** CustomGPT limits the number of calls that can be used in a schema to 30, so the schema below is a trimmed subset of REST API v2 covering about 30 operations. Swap calls in and out to suit your needs if necessary. If you need the full API surface for your own software, use the complete [OpenAPI specification](https://raw.githubusercontent.com/mainwp/docs/main/api-reference/openapi.yaml) instead.
