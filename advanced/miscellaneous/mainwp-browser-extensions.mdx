...
Most monitoring details appear inside the extension popup. Update and Non-MainWP change counts are shown in the popup after the extension syncs with MainWP Dashboard.

When a Time Tracker timer is running or paused, the toolbar badge shows elapsed time. When the timer stops, the badge clears.
