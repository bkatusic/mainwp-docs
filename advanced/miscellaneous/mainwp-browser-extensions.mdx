...
<iframe
  ...
  src="https://www.youtube.com/embed/G6oE1LCKAO0"
  title="MainWP Browser Extension - Video Tutorial"
  frameBorder="0"
...
![MainWP Browser Extension toolbar popup showing update and tracker status](/images/miscellaneous/mainwp-browser-extension-toolbar.png)

The toolbar badge shows quick status after the extension syncs.

For update monitoring, a badge like `5-2` means `5` selected updates and `2` Non-MainWP changes. Each number is capped at `99`, and the badge is blank when both counts are zero.
...
![MainWP Browser Extension Updates view showing pending updates and Non-MainWP changes](/images/miscellaneous/mainwp-browser-extension-updates.jpg)
...
![MainWP Browser Extension Time Tracker view with timer controls and paused timers](/images/miscellaneous/mainwp-browser-extension-time-tracker.jpg)
...
![MainWP Browser Extension Cost Tracker view showing cost totals and license expiration alerts](/images/miscellaneous/mainwp-browser-extension-cost-tracker.jpg)
